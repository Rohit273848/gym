      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-stretch">
          ...
          <div className="bg-zinc-900/60 border border-zinc-800 rounded-3xl p-8 text-center flex flex-col justify-between hover:border-red-600/40 transition-colors">
              ...
              <div className="flex flex-col gap-2 mb-6">
                {GYM_DATA.contact.phones.map((ph) => (
                  <a
                    key={ph}
                    href={`tel:${ph}`}
                    className="font-heading font-black text-2xl text-white hover:text-red-500 transition-colors"
                  >
                    +91 {ph}
                  </a>
                ))}
            ...
            <a
              href={`tel:${GYM_DATA.contact.phones[0]}`}
              className="w-full py-3.5 bg-red-600 hover:bg-red-700 text-white font-heading font-extrabold text-xs tracking-widest uppercase rounded-full shadow-lg shadow-red-600/30 transition-all flex items-center justify-center gap-2"
            >
